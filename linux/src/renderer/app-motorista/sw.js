/* FAST Servicos - app FAST Motorista - Service Worker persistente (r409)
...
const C="motorista-fast-r409",A=["./","./index.html","./manifest.webmanifest","../assets/app-motorista-192.png","../assets/app-motorista-512.png"];

/* FAST Servicos - app FAST Motorista - Service Worker persistente (r408)
   ...
   Modelo network-first (igual ao r408 que sempre funcionou):
   - recursos: rede primeiro (cache:'no-store'); cache so como fallback
     quando a rede falha (offline).
   - activate: apaga caches antigos (motorista-fast-r408 e anteriores).
   - SEM self.unregister e SEM clients.navigate (nada de reload em loop). */
const C="motorista-fast-r408",A=["./","./index.html","./manifest.webmanifest","../assets/app-motorista-192.png","../assets/app-motorista-512.png"];

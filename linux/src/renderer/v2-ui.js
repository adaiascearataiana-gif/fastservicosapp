(function(){
  'use strict';
  var VERSION='2.1.0',MIGRATION_KEY='fast_v2_migration_complete',CHECKPOINT_KEY='fast_v2_pre_migration_checkpoint';
  var commands=[
  ...
  function install(){
    ...
    setTimeout(function(){toast('FAST Serviços 2.1.0 pronto para operar.')},900);
  }

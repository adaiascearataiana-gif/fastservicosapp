/* FAST Servicos - app Rotas do Dia - Service Worker persistente (r134; r244 = novos icones)
...
const CACHE='fast-rotas-dia-r244';
const CORE=['./','./index.html','./manifest.webmanifest','../assets/atalho-rotas-dia-192.png?v=r244','../assets/atalho-rotas-dia-512.png?v=r244'];

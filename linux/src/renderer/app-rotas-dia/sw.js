/* FAST Servicos - app Rotas do Dia - Service Worker persistente (r134; r248 = novos icones)
...
const CACHE='fast-rotas-dia-r248';
const CORE=['./','./index.html','./manifest.webmanifest','../assets/atalho-rotas-dia-192.png?v=r248','../assets/atalho-rotas-dia-512.png?v=r248'];

/* FAST Servicos - app Rotas do Dia - Service Worker persistente (r134; r249 = novos icones)
...
const CACHE='fast-rotas-dia-r249';
const CORE=['./','./index.html','./manifest.webmanifest','../assets/atalho-rotas-dia-192.png?v=r249','../assets/atalho-rotas-dia-512.png?v=r249'];

/* FAST Servicos - app Rotas do Dia - Service Worker persistente (r134; r4000 = novos icones)
...
const CACHE='fast-rotas-dia-r4000';
const CORE=['./','./index.html','./manifest.webmanifest','../assets/atalho-rotas-dia-192.png?v=r4000','../assets/atalho-rotas-dia-512.png?v=r4000'];

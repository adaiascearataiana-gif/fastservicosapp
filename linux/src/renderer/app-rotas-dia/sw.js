/* FAST Servicos - app Rotas do Dia - Service Worker persistente (r134; r404 = novos icones)
...
const CACHE='fast-rotas-dia-r404';
const CORE=['./','./index.html','./manifest.webmanifest','../assets/app-rotas-dia-192.png?v=r404','../assets/app-rotas-dia-512.png?v=r404'];

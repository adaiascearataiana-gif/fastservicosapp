/* FAST Servicos - app Rotas do Dia - Service Worker persistente (r134; r4010 = novos icones)
...
const CACHE='fast-rotas-dia-r4010';
const CORE=['./','./index.html','./manifest.webmanifest','../assets/app-rotas-dia-192.png?v=r4010','../assets/app-rotas-dia-512.png?v=r4010'];

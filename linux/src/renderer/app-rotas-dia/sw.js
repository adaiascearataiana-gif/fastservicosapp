/* FAST Servicos - app Rotas do Dia - Service Worker persistente (r134; r3106 = novos icones)
...
const CACHE='fast-rotas-dia-r3106';
const CORE=['./','./index.html','./manifest.webmanifest','../assets/atalho-rotas-dia-192.png?v=r3106','../assets/atalho-rotas-dia-512.png?v=r3106'];

/* FAST Servicos - app Rotas do Dia - Service Worker persistente (r134; r3102 = novos icones)
...
const CACHE='fast-rotas-dia-r3102';
const CORE=['./','./index.html','./manifest.webmanifest','../assets/atalho-rotas-dia-192.png?v=r3102','../assets/atalho-rotas-dia-512.png?v=r3102'];

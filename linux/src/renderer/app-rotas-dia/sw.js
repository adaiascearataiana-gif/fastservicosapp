/* FAST Servicos - app Rotas do Dia - Service Worker persistente (r134; r402 = novos icones)
...
const CACHE='fast-rotas-dia-r402';
const CORE=['./','./index.html','./manifest.webmanifest','../assets/atalho-rotas-dia-192.png?v=r402','../assets/atalho-rotas-dia-512.png?v=r402'];

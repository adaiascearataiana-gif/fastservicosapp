...
const CACHE='fast-rotas-dia-r144';
const CORE=['./','./index.html','./manifest.webmanifest','../assets/atalho-rotas-dia-192.png?v=r144','../assets/atalho-rotas-dia-512.png?v=r144'];

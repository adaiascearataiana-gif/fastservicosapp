/* FAST Servicos - app Cliente FAST - Service Worker persistente (r4010)
   ...
   - activate: apaga caches antigos (cliente-fast-r4010 e anteriores).
   - SEM self.unregister e SEM clients.navigate (nada de reload em loop). */
const C='cliente-fast-r4010',A=['./','./index.html','./manifest.webmanifest','../assets/app-cliente-192.png','../assets/app-cliente-512.png'];

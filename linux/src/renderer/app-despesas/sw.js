/* FAST Servicos - app Despesas - Service Worker persistente
   (r134; r144 = novos icones; r145 = SHARE TARGET unico arquivo;
    r2416 (2.3.32) = SHARE TARGET MULTI-ARQUIVO: o app Despesas aparece na
   ...
   r2416 SHARE TARGET (como funciona):
   ...
   2. O SW extrai TODOS os arquivos do formData, guarda
      ...
      (fast-despesas-share-r2416) e responde 303 para "./?share=1".
...
const CACHE='fast-despesas-r2416';
const CORE=['./','./index.html','./manifest.webmanifest','../assets/atalho-despesas-192.png?v=r2416','../assets/atalho-despesas-512.png?v=r2416'];
const SHARE_CACHE='fast-despesas-share-r2416';
    ...
    event.respondWith(
      lerShare().then(function(pacote){
        ...
        if(pacote&&pacote.files&&pacote.files.length){
          /* formato novo r2416 (lista) + campo "item" de compat r145 */

/* FAST Servicos - app Cliente FAST - Service Worker persistente (r407)
   ...
   - activate: apaga caches antigos (cliente-fast-r407 e anteriores).
   - SEM self.unregister e SEM clients.navigate (nada de reload em loop). */
const C='cliente-fast-r407',A=['./','./index.html','./manifest.webmanifest','../assets/app-cliente-192.png','../assets/app-cliente-512.png'];

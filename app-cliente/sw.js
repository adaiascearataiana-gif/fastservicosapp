/* FAST Servicos - app Cliente FAST - Service Worker persistente (r3105)
   ...
   - activate: apaga caches antigos (cliente-fast-r3105 e anteriores).
   - SEM self.unregister e SEM clients.navigate (nada de reload em loop). */
const C='cliente-fast-r3105',A=['./','./index.html','./manifest.webmanifest','../assets/fast-servicos-icon-192.png','../assets/fast-servicos-icon-512.png'];

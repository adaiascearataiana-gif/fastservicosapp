/* FAST Servicos - app FAST Motorista - Service Worker persistente (r3104)
   ...
   Modelo network-first (igual ao r3104 que sempre funcionou):
   - recursos: rede primeiro (cache:'no-store'); cache so como fallback
     quando a rede falha (offline).
   - activate: apaga caches antigos (motorista-fast-r3104 e anteriores).
   - SEM self.unregister e SEM clients.navigate (nada de reload em loop). */
const C="motorista-fast-r3104",A=["./","./index.html","./manifest.webmanifest","../assets/fast-servicos-icon-192.png","../assets/fast-servicos-icon-512.png"];

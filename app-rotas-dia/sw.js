/* FAST Servicos - app Rotas do Dia - Service Worker persistente (r134; r247 = novos icones)
...
const CACHE='fast-rotas-dia-r247';
const CORE=['./','./index.html','./manifest.webmanifest','../assets/atalho-rotas-dia-192.png?v=r247','../assets/atalho-rotas-dia-512.png?v=r247'];

/* FAST Servicos - app Rotas do Dia - Service Worker persistente (r134; r4001 = novos icones)
...
const CACHE='fast-rotas-dia-r4001';
const CORE=['./','./index.html','./manifest.webmanifest','../assets/atalho-rotas-dia-192.png?v=r4001','../assets/atalho-rotas-dia-512.png?v=r4001'];

/* FAST Servicos - app Rotas do Dia - Service Worker persistente (r134; r407 = novos icones)
...
const CACHE='fast-rotas-dia-r407';
const CORE=['./','./index.html','./manifest.webmanifest','../assets/app-rotas-dia-192.png?v=r407','../assets/app-rotas-dia-512.png?v=r407'];

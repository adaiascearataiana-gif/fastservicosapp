/* FAST Servicos - app Rotas do Dia - Service Worker persistente (r134; r3105 = novos icones)
...
const CACHE='fast-rotas-dia-r3105';
const CORE=['./','./index.html','./manifest.webmanifest','../assets/atalho-rotas-dia-192.png?v=r3105','../assets/atalho-rotas-dia-512.png?v=r3105'];

/* FAST Servicos - app Rotas do Dia - Service Worker persistente (r134; neon4034 = novos icones)
...
const CACHE='fast-rotas-dia-neon4034';
const CORE=['./','./index.html','./manifest.webmanifest','../assets/app-rotas-dia-192.png?v=neon4034','../assets/app-rotas-dia-512.png?v=neon4034'];

/* FAST Servicos - app Rotas do Dia - Service Worker persistente (r134; r403 = novos icones)
...
const CACHE='fast-rotas-dia-r403';
const CORE=['./','./index.html','./manifest.webmanifest','../assets/app-rotas-dia-192.png?v=r403','../assets/app-rotas-dia-512.png?v=r403'];

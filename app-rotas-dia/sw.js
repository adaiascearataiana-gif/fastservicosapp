/* FAST Servicos - app Rotas do Dia - Service Worker persistente (r134; r245 = novos icones)
...
const CACHE='fast-rotas-dia-r245';
const CORE=['./','./index.html','./manifest.webmanifest','../assets/atalho-rotas-dia-192.png?v=r245','../assets/atalho-rotas-dia-512.png?v=r245'];

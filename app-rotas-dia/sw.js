/* FAST Servicos - app Rotas do Dia - Service Worker persistente (r134; r2411 = novos icones)
...
const CACHE='fast-rotas-dia-r2411';
const CORE=['./','./index.html','./manifest.webmanifest','../assets/atalho-rotas-dia-192.png?v=r2411','../assets/atalho-rotas-dia-512.png?v=r2411'];

/* FAST Servicos - app Rotas do Dia - Service Worker persistente (r134; r2410 = novos icones)
...
const CACHE='fast-rotas-dia-r2410';
const CORE=['./','./index.html','./manifest.webmanifest','../assets/atalho-rotas-dia-192.png?v=r2410','../assets/atalho-rotas-dia-512.png?v=r2410'];

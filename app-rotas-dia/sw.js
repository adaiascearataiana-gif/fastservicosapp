/* FAST Servicos - app Rotas do Dia - Service Worker persistente (r134; r3000 = novos icones)
...
const CACHE='fast-rotas-dia-r3000';
const CORE=['./','./index.html','./manifest.webmanifest','../assets/atalho-rotas-dia-192.png?v=r3000','../assets/atalho-rotas-dia-512.png?v=r3000'];

(function(){
  'use strict';
  var VERSION='2.0.0',MIGRATION_KEY='fast_v2_migration_complete',CHECKPOINT_KEY='fast_v2_pre_migration_checkpoint';
  var commands=[
  ...
  function install(){
    ...
    var latest=document.querySelector('meta[name="fast-latest-update"]');if(latest)latest.content='FAST Serviços 2.0: nova arquitetura visual, central rápida, modo foco, densidade ajustável e migração com ponto de restauração automático.';
    ...
    var menu=document.getElementById('navMenuVersao');if(menu)menu.textContent='Versão 2.0';
    var splash=document.getElementById('fastSplashVersion');if(splash)splash.textContent='2.0.0';
    var gate=document.getElementById('fastGateVersionNum');if(gate)gate.textContent='2.0.0';
    ...
    setTimeout(function(){toast('FAST Serviços 2.0 pronto para operar.')},900);
  }

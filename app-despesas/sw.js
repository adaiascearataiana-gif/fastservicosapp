/* FAST Servicos - app Despesas - Service Worker persistente
   (r134; r144 = novos icones; r145 = SHARE TARGET unico arquivo;
    r3101 (2.3.32) = SHARE TARGET MULTI-ARQUIVO: o app Despesas aparece na
   ...
   r3101 SHARE TARGET (como funciona):
   ...
   2. O SW extrai TODOS os arquivos do formData, guarda
      ...
      (fast-despesas-share-r3101) e responde 303 para "./?share=1".
...
const CACHE='fast-despesas-r3101';
const CORE=['./','./index.html','./manifest.webmanifest','../assets/atalho-despesas-192.png?v=r3101','../assets/atalho-despesas-512.png?v=r3101'];
const SHARE_CACHE='fast-despesas-share-r3101';
    ...
    event.respondWith(
      lerShare().then(function(pacote){
        ...
        if(pacote&&pacote.files&&pacote.files.length){
          /* formato novo r3101 (lista) + campo "item" de compat r145 */
